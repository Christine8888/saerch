...
client = OpenAI(api_key=config['jwu_openai_key']) #config['openai_api_key'])

EMBEDDING_MODEL = "text-embedding-3-small"

# Load pre-computed embeddings and texts
embeddings_path = "../data/vector_store_astroPH/abstract_embeddings.npy"
texts_path = "../data/vector_store_astroPH/abstract_texts.json"
feature_analysis_path = "sae_data_astroPH/feature_analysis_results_64.json"
metadata_path = 'sae_data_astroPH/astro_paper_metadata.csv'
