...
"""
    ...
    def __init__(self, config_path: Path, feature_index: int, num_samples: int, k: int = 64, ndirs: int = 9216):
    ...
    def load_sae_data(self) -> Tuple[np.ndarray, np.ndarray]:
        topk_indices = np.load(SAE_DATA_DIR / "topk_indices_{}_{}.npy".format(self.k, self.ndirs))
        topk_values = np.load(SAE_DATA_DIR / "topk_values_{}_{}.npy".format(self.k, self.ndirs))
    ...
    def generate_family_feature(self, parent, feature_names):
        ...
        prompt = """You are an expert research astronomer trying to understand the relationships between scientific concepts related to astronomy and astrophysics.
                    
                    INPUT_DESCRIPTION: 
                    You will be given a list of specific concepts related to astronomy and astrophysics. There will be 1 parent feature and many child features.
                    
                    OUTPUT_DESCRIPTION:
                    Given the inputs provided, think about what general concept these specific concepts are related to. 
                    The general concept may be very similar to the parent concept, but not necessarily.
                    Be as specific as possible, but ensure that the general concept is broad enough to encompass the child concepts.
                    Do not include "in astronomy" or "in astrophysics" in the general concept, unless this is strictly necessary.
                    Provide the general concept in the form "FINAL: <general concept>". Do NOT return anything after this.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_samples", type=int, default=10, help="Number of samples to use for analysis")
