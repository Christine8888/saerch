...
data_path = '../data/vector_store_astroPH'
sae_data_path = '../saerch/sae_data_astroPH'

auto_results = json.load(open(sae_data_path + '/feature_analysis_results_64.json'))
auto_embeds = np.load(sae_data_path + '/feature_embeddings.npy')
auto_labels = open(sae_data_path + '/feature_labels.txt').read().splitlines()
abstract_embeddings = np.load(data_path + "/abstract_embeddings.npy")
abstract_texts = json.load(open(data_path + '/abstract_texts.json'))['abstracts']
